...
namespace DaysCalculator
{
    public class CalculateDays
    {
        ...
        public CalculateDays(DateTime Bday)
        {
            this.Count(Bday);
        }

        public CalculateDays(DateTime Bday, DateTime Cday)
        {
            this.Count(Bday, Cday);
        }

        public CalculateDays Count(DateTime Bday)
        {
            return this.Count(Bday, DateTime.Today);
        }

        public CalculateDays Count(DateTime Bday, DateTime Cday)
        {
