namespace BackGround_Threads
{
    ...
    {
        public Dictionary<int, Employees> employeeInfo = new Dictionary<int, Employees>()
        {
    ...
    {
        public Dictionary<int, Department> departmentInfo = new Dictionary<int, Department>()
       {
