...
String filename = "DBFile.txt";//Console.ReadLine();
//op.CreateFile(filePath, filename);

var staff = new Doctor() { StaffId = 101, StaffName = "pawan", ContactNo = 87363, Department = "Doctor", Education = "M.B.B.S", BasicPay = 34000, Email = "vasa@gmail.com", Location = "Pune", ShiftEndTime = 5, ShiftStartTime = 18, Specilization = "Eye" };
...
do
{
    ...
    switch (res)
    {
        case 1:
            ...
            op.ReadFileByCategory(category!);
            break;
