...
namespace EF_Core_Second.Migrations
{
    ...
    [Migration("20221018062821_firstmigrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Person", b =>
                {
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Product", b =>
                {
            ...
            modelBuilder.Entity("EF_Core_Second.Models.ProductionUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Movies", b =>
                {
                    b.HasBaseType("EF_Core_Second.Models.ProductionUnit");
            ...
            modelBuilder.Entity("EF_Core_Second.Models.WebSeries", b =>
                {
                    b.HasBaseType("EF_Core_Second.Models.ProductionUnit");
            ...
            modelBuilder.Entity("CustomerOrder", b =>
                {
                    b.HasOne("EF_Core_Second.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomersCustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EF_Core_Second.Models.Order", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EF_Core_Second.Models.Product", b =>
                {
                    b.HasOne("EF_Core_Second.Models.Category", "Category")
                        .WithMany("Products")
